...
function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto p-6 text-black jost">
      <h1 className="text-4xl font-bold mb-6 text-center text-[#C34040] gilda-display-regular ">Privacy Policy</h1>
