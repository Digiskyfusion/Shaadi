...
function MatchesFull() {
  ...
  return (
    <div className="bg-[#FAF4EE] py-6 px-4">
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 justify-center items-start">
        <div className="w-full max-w-md">
          <h2 className="text-lg font-semibold text-gray-800 mb-3 text-center">My Matches</h2>
          <Matches data={matchData} />
        </div>
        <div className="w-full max-w-md">
          <h2 className="text-lg font-semibold text-gray-800 mb-3 text-center">New Matches for You</h2>
          <Matches data={matchData} />
        </div>
      </div>
    </div>
