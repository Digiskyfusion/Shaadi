...
const SecondProfile = () => {
  ...
  <div className="flex flex-wrap items-start gap-4 mb-6">
    ...
    <div className="w-full md:w-auto">
      <h3 className="text-xl font-normal mb-2 text-[#000000]">About Jazzleen D</h3>
      <p className="text-sm leading-relaxed text-[#000000]">
        It feels good to introduce myself.Honesty and integrity are the guiding values of my life. I am looking for a simple and sober person who will be with me in all phases of life. Thanks for going through my profile. I want ki koi mughe itna pyaar kare jitna kisi ne kisi se n kra ho jo memo princess treatment de meko support mre mera sath de meri family ki respect kre mei uaki family ki respect kru meko Western clothes wear krna bhut psnd hai meko clubs concerts jane ka bhut shonk Hai i want to be a businesswomen
      </p>
    </div>
  </div>
  ...
  <div className="flex flex-wrap items-start space-x-4 mb-10">
    ...
    {/* Title and chips */}
    <div>
      <h3 className="text-2xl font-normal text-[#000000] mb-6">Hobbies & Interests</h3>
  ...
  <div className="flex flex-wrap items-start space-x-4 mb-10">
    ...
    <div className="mb-6 w-full sm:w-auto">
      <h3 className="text-xl font-normal mb-2 text-[#000000]">Contact Details</h3>
      ...
      <div className="relative flex items-center text-sm left-[97%] bottom-20">
        <div className="w-6 h-6 rounded-full border-3 border-amber-50 flex items-center justify-center mr-2">
          <FontAwesomeIcon icon={faUnlock} className="text-[#FF5A60] text-[15px]" />
        </div>
        <span className="text-[#FF5A60] font-semibold mr-1">Upgrade Now</span>
    ...
    <div className="w-full md:w-auto">
      ...
      <div className="space-y-2">
        ...
        <p className="text-[#000000]">
          <span className="font-bold">Self: </span> Earns Upto INR 1 Lakh annually
        </p>
        <p className="text-[#000000]">
          <span className="font-bold">Family:</span> Earns INR 10-30 lakhs annually
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="flex flex-wrap items-start space-x-4 mb-7">
    ...
    {/* Profile Matches */}
    <div>
      <h3 className="text-2xl font-normal text-[#000000] mb-4">What She is looking for</h3>
      <div className="bg-peach-100 p-6 rounded-lg max-w-2xl mx-auto text-[#FF5A60]">
        <div className="flex justify-between items-center mb-4 space-y-2">
          <div className="flex flex-col items-center">
            <img src={image6} alt="Her Preferences" className="rounded-full w-20 h-20" />
          ...
          <div className="flex flex-col items-center ml-8">
            <img src={image7} alt="You Match" className="rounded-full w-20 h-20" />
