...
function Planpage() {
  ...
  return (
    <div
      ...
      className="bg-white py-1 px-1 sm:px-8"
      style={{
    ...
    >
      ...
      <h1 className=" text-center mt-96 text-6xl text-amber-50 font-serif">Upgrade now & Get Premium benefits</h1>
      <h2 className='text-center text-amber-50 text-2xl font-normal mt-2'>Upgrade to any of our Premium Plans we gurantee you will find a match!</h2>
