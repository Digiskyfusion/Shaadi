...
function FirstBlog() {
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 jost">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {articles.map((article, index) => (
          <div key={index} className="bg-white shadow-md border rounded-md overflow-hidden">
            <img src={article.image} alt="Article" className="w-full h-56 object-cover" />
            <div className="p-4">
  ...
  <button className="bg-[#EB5757] hover:bg-[#000000] text-white px-13 py-2 text-sm rounded-full">
    Read More
  </button>
</div>
